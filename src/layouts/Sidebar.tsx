...
const NAV_ITEMS: NavItem[] = [
	...
	{
		id: "nav-courses",
		labelKey: "navigation.learningPlan",
		to: "/courses",
	...
	{
		id: "nav-media",
		labelKey: "navigation.mediaLibrary",
		to: "/media-library",
		iconName: "video_library",
		featureFlag: "mediaLibrary",
	},
	{
		id: "nav-jobs",
		labelKey: "navigation.jobOffers",
		to: "/job-offers",
		iconName: "work",
		featureFlag: "jobOffers",
	},
];
...
function FeatureFlaggedNavItem({
	item,
	flag,
	label,
}: FeatureFlaggedNavItemProps) {
		...
		<aside className="w-[232px] shrink-0 py-2 pl-2 flex flex-col bg-surface-container">
			...
			<div
				...
				style={{
					...
					boxShadow:
						"0px 0px 0px 1px rgba(0,0,0,0.08), 0px 8px 32px 0px rgba(0,0,0,0.12)",
				}}
			>
				{/* Logo-Bereich */}
